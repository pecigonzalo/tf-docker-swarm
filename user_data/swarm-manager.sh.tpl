...
echo "[main]" >> /var/lib/docker/swarm/elb.cfg
echo "# hostname : ELB_name" >> /var/lib/docker/swarm/elb.cfg
echo "127.0.0.1: $EXTERNAL_LB" >> /var/lib/docker/swarm/elb.cfg
echo "localhost: $EXTERNAL_LB" >> /var/lib/docker/swarm/elb.cfg
echo "default: $EXTERNAL_LB" >> /var/lib/docker/swarm/elb.cfg
